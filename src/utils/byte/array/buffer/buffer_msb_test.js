/**
 * @fileoverview ByteArray Buffer MSB tests.
 *
 ...
 */
goog.require('cwc.lib.utils.byte.array.BufferMSB');


goog.scope(function() {
const ByteBuffer = goog.module.get('cwc.lib.utils.byte.array.BufferMSB');

describe('ByteBuffer MSB', function() {
  it('writeShort', function() {
    ...
    expect(byteBufferTest.get()[3]).toEqual(0x80);
    expect(byteBufferTest.get()[4]).toEqual(0x00);
    expect(byteBufferTest.get()[5]).toEqual(0xFF);
    expect(byteBufferTest.get()[6]).toEqual(0x02);
    expect(byteBufferTest.get()[7]).toEqual(0x00);
    expect(byteBufferTest.get()[8]).toEqual(0x00);
    expect(byteBufferTest.get()[9]).toEqual(0x20);
    expect(byteBufferTest.get()[10]).toEqual(0x01);
    expect(byteBufferTest.get()[11]).toEqual(0xF4);
  });
  ...
  it('writeLong', function() {
    ...
    expect(byteBufferTest.get()[10]).toEqual(0x04);
    expect(byteBufferTest.get()[11]).toEqual(0x00);

    expect(byteBufferTest.get()[12]).toEqual(0x62);
    expect(byteBufferTest.get()[13]).toEqual(0x8D);
    expect(byteBufferTest.get()[14]).toEqual(0xE2);
    expect(byteBufferTest.get()[15]).toEqual(0xE0);
  });
});
});
